...
import { ChevronsLeft, MenuIcon, PlusCircle } from "lucide-react"; // Updated MenuIcon to Menu
  ...
  return (
    <>
      ...
      >
        ...
        <div>
          <UserItem />
          <Item label="new" onClick={() => {}} icon={PlusCircle} />
        </div>
        <div className="mt-4">
        ...
        <div
          ...
          onClick={resetWidth}
          className="opacity-0 group-hover/sidebar:opacity-100 transition cursor-ew-resize absolute h-screen w-1 bg-gray-500
        right-0 top-0"
        />
      </aside>
